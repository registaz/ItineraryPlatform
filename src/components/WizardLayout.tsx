            ...
            <div className="max-w-4xl mx-auto flex justify-between items-center gap-4">
              ...
              {currentStep < steps.length && (
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-2.5 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors duration-200 active:scale-95"
                >
                  Next →
                </button>
              )}
